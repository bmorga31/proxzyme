...
#'
#' Key for plate layour for twwen experiment spectifying the treatment/condition
#' of each well
#'
...
#' water, containd no additional buffer components (TE buffer, *Salt, 5mg/50ml Hemin, DMSO),
